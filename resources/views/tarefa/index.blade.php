                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="float-right">
                                ...
                                <a href="{{route('task.exportacao', ['extensao' => 'xlsx'])}}" class="mr-3">XLSX</a>
                                <a href="{{route('task.exportacao', ['extensao' => 'csv'])}}" class="mr-3">CSV</a>
                                <a href="{{route('task.exportacao', ['extensao' => 'pdf'])}}" class="mr-3">PDF</a>
                                <a href="{{route('task.export')}}" target="_blank">PDF V2</a>
                            </div>
                        </div>
                    </div>
                </div>
